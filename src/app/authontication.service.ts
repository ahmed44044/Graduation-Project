...
this.isLogin.next(role);
  ...
  getCourses():Observable<any>
  {
      ...
      let userData:any = jwtDecode(t);
      let id=userData.id

console.log(id);

   return this._HttpClinet.get(`https://student-project-final2.vercel.app/api/v1/user/allCourses/${id}`,
   {
    headers:new HttpHeaders({
      'authorization':`Bearer__${t}`
    })
  ...
  profile():Observable<any>
  {
   ...
   return this._HttpClinet.get(`https://student-project-final2.vercel.app/api/v1/user/student/${id}`,
   {
    headers:new HttpHeaders({
      'authorization':`Bearer__${t}`
    })
